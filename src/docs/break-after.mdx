...
export const title = "换页模式";
export const description = "用于控制元素后列或页面如何换行的工具类。";
...
使用 `break-after-column` 和 `break-after-page` 等工具类控制元素后列或页面的换行行为：

```html
<!-- [!code classes:break-after-column] -->
<div class="columns-2">
  <p>好吧，让我告诉你一些事情，...</p>
  <p class="break-after-column">当然，可以，笑吧...</p>
  <p>也许我们可以不必...</p>
  <p>看。如果你认为这是...</p>
</div>
```
