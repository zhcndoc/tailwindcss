...
export const description = "在 Tailwind CSS 项目中使用和自定义颜色调色板。";

Tailwind CSS 内置了一个庞大而美丽的颜色调色板，由专业设计师精心打造，适合多种不同的设计风格。

<div className="my-10">
  {/* <TipInfo>{<>点击复制 OKLCH，按住 shift 点击复制最近的 hex</>}</TipInfo> */}
  {/* <div className="mt-6"> */}
  <ColorPalette />
  {/* </div> */}
</div>

默认调色板中的每个颜色包含 11 个步骤，50 为最浅，950 为最深：
...
整个颜色调色板可用于所有颜色相关的工具，包括 [背景颜色](/docs/background-color)，[边框颜色](/docs/border-color)，[填充](/docs/fill)，[光标颜色](/docs/caret-color)等许多其他功能。

## 处理颜色

### 使用颜色工具

使用颜色工具如 `bg-white`, `border-pink-300` 和 `text-gray-950` 来设置设计中元素的不同颜色属性：
      ...
      <div className="mx-auto flex max-w-md items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
        ...
        <div>
          <p className="text-gray-700 dark:text-gray-400">
            <span className="font-medium text-gray-950 dark:text-white">Tom Watson</span> 提到您在{" "}
            <span className="font-medium text-gray-950 dark:text-white">Logo 重新设计</span>
          </p>
...
<div class="flex items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
  ...
  <div>
    <p class="text-gray-700 dark:text-gray-400">
      <span class="font-medium text-gray-950 dark:text-white">Tom Watson</span> 提到您在
      <span class="font-medium text-gray-950 dark:text-white">Logo 重新设计</span>
    </p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        设置元素的 <a href="/docs/background-color">背景颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置元素的 <a href="/docs/text-color">文本颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置元素的 <a href="/docs/text-decoration-color">文本装饰颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置元素的 <a href="/docs/border-color">边框颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置元素的 <a href="/docs/outline-color">轮廓颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 <a href="/docs/box-shadow#setting-the-shadow-color">盒子阴影</a> 的颜色
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 <a href="/docs/box-shadow#setting-the-inset-shadow-color">内嵌盒子阴影</a> 的颜色
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 <a href="/docs/box-shadow#setting-the-ring-color">环形阴影</a> 的颜色
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 <a href="/docs/box-shadow#setting-the-inset-ring-color">内嵌环形阴影</a> 的颜色
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置表单控件的 <a href="/docs/accent-color">强调颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置表单控件中的 <a href="/docs/caret-color">光标颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 SVG 元素的 <a href="/docs/fill">填充颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置 SVG 元素的 <a href="/docs/stroke">描边颜色</a>
      </td>
    </tr>
  </tbody>
</table>
...
您可以使用语法如 `bg-black/75` 调整颜色的不透明度，其中 `75` 将颜色的 alpha 通道设置为 75%：
...
使用 `dark` 变体来编写类似 `dark:bg-gray-800` 的类，仅在暗模式激活时应用颜色：
...
<Example padding={false}>
  {
    <div className="grid grid-cols-1 sm:grid-cols-2">
      <div className="p-8 pt-7">
        <p className="mb-2 text-sm font-medium text-gray-500">亮模式</p>
        <div className="rounded-lg bg-white px-6 py-8 shadow-xl ring ring-gray-900/5">
          ...
          <p className="mt-5 text-base font-medium tracking-tight text-gray-900">可以倒着写</p>
          <p
            className="mt-2 text-sm text-gray-500"
            children={`零重力钢笔可以在任何方向书写，
          包括倒写。它甚至可以在外太空中使用。`}
          />
        </div>
      </div>
      <div className="bg-gray-900 p-8 pt-7">
        ...
        <div className="rounded-lg bg-gray-800 px-6 py-8 shadow-xl ring ring-gray-900/5">
          ...
          <p className="mt-5 text-base font-medium tracking-tight text-white">可以倒着写</p>
          <p
...
<div class="bg-white dark:bg-gray-800 rounded-lg px-6 py-8 ring shadow-xl ring-gray-900/5">
  ...
  <h3 class="text-gray-900 dark:text-white mt-5 text-base font-medium tracking-tight ">可以倒着写</h3>
  <!-- prettier-ignore -->
  <!-- [!code word:dark\:text-gray-400] -->
  <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm ">
    零重力钢笔可以在任何方向书写，包括倒写。它甚至可以在外太空中使用。
  </p>
</div>
```
...
了解有关暗模式样式的更多信息，请参见 [暗模式文档](/docs/dark-mode)。

### 在 CSS 中引用

颜色以 `--color-*` 命名空间以 CSS 变量的形式暴露，因此您可以使用诸如 `--color-blue-500` 和 `--color-pink-700` 的变量在 CSS 中引用它们：
...
要快速调整通过 CSS 中的变量引用的颜色的不透明度，Tailwind 包含一个特殊的 <code>--alpha()</code> 函数：
...
使用 `@theme` 在 `--color-*` 主题命名空间下将自定义颜色添加到您的项目中：
...
现在，像 `bg-midnight`、`text-tahiti` 和 `fill-bermuda` 这样的工具将在您的项目中可用，除此之外还有默认颜色。

了解有关主题变量的更多信息，请参见 [主题变量文档](/docs/theme)。

### 重写默认颜色

通过定义与同名的新主题变量，可以覆盖任何默认颜色：
...
通过将其主题命名空间设置为 `initial`，可以禁用任何默认颜色：
...
这对于移除您打算不使用的颜色的对应 CSS 变量特别有用。

### 使用自定义调色板

使用 `--color-*: initial` 完全禁用所有默认颜色并定义自己的自定义颜色调色板：
...
要了解更多信息，请参见主题文档中关于 [引用其他变量](/docs/theme#referencing-other-variables)。
...
这非常有用，如果您想在不同的名称下重用这些色阶，例如重新定义 `--color-gray-*` 为使用 `--color-slate-*` 色阶。
