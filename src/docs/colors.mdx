...
Tailwind CSS 默认提供了一个丰富而美丽的色板，这些颜色经过专业设计师精心设计，适用于各种不同的设计风格。

<div className="relative my-10">
  {/* <TipInfo>{<>点击复制 OKLCH，Shift+点击复制最近的十六进制色值</>}</TipInfo> */}
  {/* <div className="mt-6"> */}
  <ColorPalette />
  {/* </div> */}
</div>
...
整个颜色色板可用于所有与颜色相关的工具，包括[背景颜色](/docs/background-color)、[边框颜色](/docs/border-color)、[填充](/docs/fill)、[光标颜色](/docs/caret-color)等。

## 处理颜色

### 使用颜色工具

使用颜色工具，如 `bg-white`、`border-pink-300` 和 `text-gray-950`，设置设计中元素的不同颜色属性：
      ...
      <div className="mx-auto flex max-w-md items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
        ...
        <div>
          <p className="text-gray-700 dark:text-gray-400">
            <span className="font-medium text-gray-950 dark:text-white">Tom Watson</span> 在{" "}
            <span className="font-medium text-gray-950 dark:text-white">Logo 重塑</span>中提到了你
          </p>
          <p className="mt-1 text-gray-500">上午9:37</p>
        </div>
      </div>
    </div>
  }
...
<div class="flex items-center gap-4 rounded-lg bg-white p-6 shadow-md outline outline-black/5 dark:bg-gray-800">
  ...
  <div>
    <p class="text-gray-700 dark:text-gray-400">
      <span class="font-medium text-gray-950 dark:text-white">Tom Watson</span> 在
      <span class="font-medium text-gray-950 dark:text-white">Logo 重塑</span>中提到了你
    </p>
    <time class="mt-1 block text-gray-500" datetime="9:37">上午9:37</time>
  </div>
</div>
```
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        设置一个元素的 <a href="/docs/background-color">背景颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置一个元素的 <a href="/docs/text-color">文本颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置一个元素的 <a href="/docs/text-decoration-color">文本装饰颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置一个元素的 <a href="/docs/border-color">边框颜色</a>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        设置一个元素的 <a href="/docs/outline-color">轮廓颜色</a>
      </td>
    </tr>
    <tr>
      <td>
...
使用 `dark` 变体编写类似 `dark:bg-gray-800` 的类，仅在深色模式激活时应用颜色：
...
<Example padding={false}>
  {
    <div className="grid grid-cols-1 sm:grid-cols-2">
      <div className="p-8 pt-7">
        <p className="mb-2 text-sm font-medium text-gray-500">浅色模式</p>
        <div className="rounded-lg bg-white px-6 py-8 shadow-xl ring ring-gray-900/5">
          ...
          <p
            ...
            children={`零重力笔可以在任何方向上书写，
          包括倒着写。它甚至在外太空中也能使用。`}
          />
        </div>
      </div>
      <div className="bg-gray-900 p-8 pt-7">
        <p className="mb-2 text-sm font-medium text-gray-400">深色模式</p>
...
<div class="bg-white dark:bg-gray-800 rounded-lg px-6 py-8 ring shadow-xl ring-gray-900/5">
  ...
  <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm ">
    零重力笔可以在任何方向上书写，包括倒着写。它甚至在外太空中也能使用。
  </p>
</div>
```
...
了解有关深色模式样式的更多信息，请参阅 [深色模式文档](/docs/dark-mode)。

### 在 CSS 中引用

颜色以 `--color-*` 命名空间的 CSS 变量形式暴露，因此您可以使用像 `--color-blue-500` 和 `--color-pink-700` 的变量在 CSS 中引用它们：
...
要在以变量引用颜色时快速调整不透明度，Tailwind 提供了一个特殊的 <code>--alpha()</code> 函数：
...
现在，像 `bg-midnight`、`text-tahiti` 和 `fill-bermuda` 这样的工具将在您的项目中可用，以及默认颜色。

了解有关主题变量的更多信息，请查看 [主题变量文档](/docs/theme)。

### 覆盖默认颜色

通过定义相同名称的新主题变量来覆盖任何默认颜色：
...
这对于从输出中删除您不打算使用的颜色对应的 CSS 变量特别有用。

### 使用自定义调色板

使用 `--color-*: initial` 完全禁用所有默认颜色，并定义您自己的自定义调色板：
...
在主题文档中了解更多关于[引用其他变量的内容](/docs/theme#referencing-other-variables)。
...
如果您希望以不同的名称重用这些色阶，例如重新定义 `--color-gray-*` 以使用 `--color-slate-*` 色阶，这将非常有用。