...
export const description = "在元素上应用后景灰度滤镜的工具类。";
...
使用像 `backdrop-grayscale-50` 和 `backdrop-grayscale` 的工具类来控制应用于元素后景的灰度效果：
...
<UsingACustomValue utility="backdrop-grayscale" value="0.5" name="后景灰度" />
