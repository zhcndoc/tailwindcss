...
export const title = "列表样式位置";
export const description = "控制列表中项目符号和数字位置的工具。";
...
使用类似 `list-inside` 和 `list-outside` 的工具来控制列表中标记和文本缩进的位置：
...
<Example>
  {
    <div className="flex flex-col gap-8 sm:flex-row">
      <div className="relative">
        ...
        <p className="mb-3 ml-8 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">列表内部</p>
      ...
      <div className="relative">
        ...
        <p className="mb-3 ml-8 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">列表外部</p>
