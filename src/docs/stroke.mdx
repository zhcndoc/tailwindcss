...
export const title = "描边";
export const description = "用于样式化 SVG 元素的描边的工具。";
...
使用像 `stroke-indigo-500` 和 `stroke-lime-600` 的工具来改变 SVG 的描边颜色：
...
这对于样式化图标集如 [Heroicons](https://heroicons.com) 很有用。

### 使用当前颜色

使用 `stroke-current` 工具将描边颜色设置为当前文本颜色：

<Figure hint="悬停在按钮上以查看描边颜色变化">
