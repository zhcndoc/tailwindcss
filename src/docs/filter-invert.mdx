...
export const title = "滤镜: invert()";
export const description = "应用反转滤镜到元素的工具。";
...
使用像 `invert` 和 `invert-20` 这样的工具来控制元素的颜色反转：
    ...
    <div className="flex scroll-p-8 justify-center overflow-scroll sm:block sm:overflow-visible">
      <div className="flex shrink-0 items-center justify-around gap-6 p-8 font-mono font-bold sm:gap-4">
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">invert-0</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">invert-20</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">invert</p>
