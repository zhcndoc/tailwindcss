...
<Example>
  {
    <div className="grid gap-x-6 gap-y-14 font-mono font-bold sm:grid-cols-2">
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">touch-auto</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">touch-none</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">touch-pan-x</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">touch-pan-y</p>
