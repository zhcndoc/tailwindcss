...
export const description = "用于控制元素在触摸屏上可以如何滚动和缩放的工具类。";
...
使用 `touch-pan-y` 和 `touch-pinch-zoom` 等工具类来控制元素在触摸屏上如何滚动（平移）和缩放（捏合）：

<Figure hint="尝试在触摸屏上平移这些图片">

<Example>
  {
    <div className="grid gap-x-6 gap-y-14 font-mono font-bold sm:grid-cols-2">
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-xs font-medium text-gray-500 dark:text-gray-400">触摸自动</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-xs font-medium text-gray-500 dark:text-gray-400">触摸无</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-xs font-medium text-gray-500 dark:text-gray-400">触摸水平滑动</p>
      ...
      <div className="flex flex-col items-center">
        <p className="mb-3 text-center font-mono text-xs font-medium text-gray-500 dark:text-gray-400">触摸垂直滑动</p>
