...
export const title = "宽高比";
export const description = "用于控制元素宽高比的实用工具。";
...
使用 <code>aspect-<var>&lt;ratio&gt;</var></code> 实用工具，例如 `aspect-3/2`，给元素设置特定的宽高比：
...
使用 `aspect-video` 实用工具给视频元素设置 16 / 9 的宽高比：
