...
export const title = "滤镜：saturate()";
export const description = "用于对元素应用饱和度滤镜的工具类。";
...
使用 `saturate-50` 和 `saturate-100` 等工具类来控制元素的饱和度：
...
```html
<!-- [!代码类:saturate-50,saturate-100,saturate-150,saturate-200] -->
