...
export const title = "光标";
export const description = "控制元素悬停时光标样式的工具类。";
...
使用 `cursor-pointer` 和 `cursor-grab` 等工具类来控制悬停在元素上时显示的光标：

<Figure hint="悬停在每个按钮上查看光标变化">
...
<button class="cursor-progress ...">正在保存...</button>
