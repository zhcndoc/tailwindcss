...
<Example>
  {
    <div className="grid grid-cols-1 gap-x-4 gap-y-8 text-center text-sm leading-6 font-bold text-white sm:grid-cols-2">
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-solid</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-dashed</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-dotted</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-double</p>
