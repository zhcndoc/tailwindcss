...
export const description = "用于将背景皮子过滤器应用于元素的工具类。";
...
使用 `backdrop-sepia` 和 `backdrop-sepia-50` 等工具类控制应用于元素背景的皮子效果：
...
```html
<!-- [!代码类:backdrop-sepia-0,backdrop-sepia-50,backdrop-sepia] -->
...
<UsingACustomValue utility="backdrop-sepia" value=".25" name="背景皮子" />
