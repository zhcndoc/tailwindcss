...
export const description = "用于控制元素在网格列中如何尺寸和位置的工具类。";
...
使用 `col-start-<number>` 或 `col-end-<number>` 工具类，如 `col-start-2` 和 `col-end-3`，使元素在 _n_ 网格线开始或结束：
...
这些工具类也可以与 `col-span-<number>` 工具类结合，以跨越特定数量的列。
