...
export const description = "选择字体宽度的工具类。";
...
使用 `font-stretch-condensed` 和 `font-stretch-expanded` 等工具类来设置字体的宽度：
...
<p class="font-stretch-extra-condensed">疾速的棕色狐狸...</p>
<p class="font-stretch-condensed">疾速的棕色狐狸...</p>
<p class="font-stretch-normal">疾速的棕色狐狸...</p>
<p class="font-stretch-expanded">疾速的棕色狐狸...</p>
<p class="font-stretch-extra-expanded">疾速的棕色狐狸...</p>
```

</Figure>

这仅适用于具有多种宽度变化的字体，否则浏览器将选择最接近的匹配项。

### 使用百分比

使用 `font-stretch-<percentage>` 工具类（如 `font-stretch-50%` 和 `font-stretch-125%`）通过百分比设置字体宽度：
...
<p class="font-stretch-50%">疾速的棕色狐狸...</p>
<p class="font-stretch-100%">疾速的棕色狐狸...</p>
<p class="font-stretch-150%">疾速的棕色狐狸...</p>
```
