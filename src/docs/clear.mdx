...
export const description = "用于控制内容包裹在元素周围的实用工具。";
...
使用 `clear-start` 和 `clear-end` 工具，这两者使用 [逻辑属性](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts) 根据文本方向映射到左侧或右侧：
