...
使用像 `object-left` 和 `object-right-bottom` 这样的工具类来指定替换元素的内容在其容器内的定位方式：

<Figure hint="悬停在示例上以查看完整图像">
    ...
    <div className="flex snap-x scroll-p-4 items-end overflow-x-scroll overflow-y-hidden p-8 pt-16 sm:grid sm:grid-cols-3 sm:gap-16">
      <div className="relative w-40 shrink-0 snap-start snap-always sm:w-auto">
        ...
        <div className="group relative mx-auto size-20 rounded-lg">
          <div className="relative z-10 h-full w-full rounded-md bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=90)] bg-[size:8rem] bg-left-top ring-1 ring-black/10 ring-inset"></div>
          <img
      ...
      <div className="relative w-40 shrink-0 snap-start snap-always sm:w-auto">
        ...
        <div className="group relative mx-auto size-20 rounded-lg">
          <div className="relative z-10 h-full w-full rounded-md bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=90)] bg-[size:8rem] bg-right-top ring-1 ring-black/10 ring-inset"></div>
          <img
      ...
      <div className="relative w-40 shrink-0 snap-start snap-always sm:w-auto">
        ...
        <div className="group relative mx-auto size-20 rounded-lg">
          <div className="relative z-10 h-full w-full rounded-md bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=90)] bg-[size:8rem] bg-left-bottom ring-1 ring-black/10 ring-inset"></div>
          <img
      ...
      <div className="relative -mx-8 w-56 shrink-0 snap-start snap-always sm:w-auto">
        ...
        <div className="group relative mx-auto size-20 rounded-lg">
          <div className="relative z-10 h-full w-full rounded-md bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=90)] bg-[size:8rem] bg-right-bottom ring-1 ring-black/10 ring-inset"></div>
          <img
...
```html
<!-- [!code classes:object-left-top,object-right-top,object-center,object-left-bottom,object-right-bottom,object-bottom,object-left,object-right,object-top] -->
