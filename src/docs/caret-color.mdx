...
export const title = "光标颜色"; // caret-color
export const description = "用于控制文本输入光标颜色的工具。"; // Utilities for controlling the color of the text input cursor.
...
使用诸如 `caret-rose-500` 和 `caret-lime-600` 的工具来改变文本输入光标的颜色：

<Figure hint="聚焦文本区域以查看新的光标颜色">
...
<UsingACustomValue element="textarea" utility="caret" value="#50d71e" name="光标颜色" variable="caret-color" /> // caret color
