...
export const title = "轮廓偏移";
export const description = "用于控制元素轮廓偏移的工具类.";
...
使用类似 `轮廓偏移-2` 和 `轮廓偏移-4` 的工具类来改变元素的轮廓偏移:
...
```html
<!-- [!code classes:outline-offset-0,轮廓偏移-2,轮廓偏移-4] -->
...
<UsingACustomValue utility="outline-offset" name="轮廓偏移" value="2vw" />
