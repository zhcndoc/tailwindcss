    ...
    <div className="px-4 sm:px-0">
      <div className="mx-auto max-w-sm p-8 text-gray-700 sm:text-base sm:leading-7 dark:text-gray-400">
        <ul className="list-image-[url('data:image/svg+xml;base64,')] pl-4 text-gray-900 dark:text-gray-200">
          <li className="pl-2">5杯切碎的松露蘑菇</li>
...
使用 <code>list-image-{'(<custom-property>)'}</code> 语法来使用 CSS 变量控制列表项的标记图像：
...
这只是 <code>list-image-{'[var(<custom-property>)]'}</code> 的简称，它为您自动添加 `var()` 函数。

### 移除标记图像

使用 `list-image-none` 工具类从列表项中移除现有的标记图像：
