...
export const title = "文本装饰颜色";
export const description = "控制文本装饰颜色的工具类。";
...
使用工具类 `decoration-sky-500` 和 `decoration-pink-500` 来改变元素的 [文本装饰](/docs/text-decoration-line) 颜色：
...
<p>快 <a href="..." class="underline hover:decoration-pink-500 ...">棕色疾走狐狸</a> 跃过懒狗。</p>
```
