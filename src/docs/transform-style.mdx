...
export const description = "控制元素子项在 3D 空间中放置的工具类。";
...
<Example>
  {
    <div className="flex flex-col justify-around gap-8 text-sm leading-6 font-bold text-white sm:flex-row sm:gap-0">
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">transform-3d</p>
        <div className="size-40 p-10">
...
没有这样，任何子项将只在 2D 空间中进行转换，而不会在 3D 空间中进行。
