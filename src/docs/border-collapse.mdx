...
export const description = "用于控制表格边框是合并还是分开的实用工具。";
...
使用 `border-collapse` 工具来将相邻单元格的边框合并为一个边框（如果可能的话）：
...
<table class="border-collapse border border-gray-400 ...">
  ...
  <tbody>
    <tr>
      <td class="border border-gray-300 ...">印第安纳</td>
      <td class="border border-gray-300 ...">印第安纳波利斯</td>
    </tr>
    <tr>
      <td class="border border-gray-300 ...">俄亥俄</td>
      <td class="border border-gray-300 ...">哥伦布</td>
    </tr>
    <tr>
      <td class="border border-gray-300 ...">密歇根</td>
...
注意，这包括在顶层 `<table>` 标签上的边框合并。

### 分开表格边框

使用 `border-separate` 工具强制每个单元格显示自己的分开边框：
