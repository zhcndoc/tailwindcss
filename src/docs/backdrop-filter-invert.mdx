...
export const description = "用于将背景反转滤镜应用于元素的工具类。";
...
使用 `backdrop-invert` 和 `backdrop-invert-65` 等工具类来控制元素背景的颜色反转：
...
<UsingACustomValue utility="backdrop-invert" value=".25" name="背景反转" variable="backdrop-inversion" />
