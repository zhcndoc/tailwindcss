...
export const description = "用于将 backdrop 反转滤镜应用于元素的工具。";
...
使用像 `backdrop-invert` 和 `backdrop-invert-65` 这样的工具来控制元素背景的颜色反转：
...
<UsingACustomValue utility="backdrop-invert" value=".25" name="反转背景" variable="backdrop-inversion" />
