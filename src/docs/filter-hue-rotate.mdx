...
export const title = "过滤器：hue-rotate()";
export const description = "用于将 hue-rotate 过滤器应用于元素的工具类。";
...
使用像 `hue-rotate-90` 和 `hue-rotate-180` 的工具类按度数旋转元素的色相：
...
使用像 `-hue-rotate-15` 和 `-hue-rotate-45` 的工具类来设置负的色相旋转值：
