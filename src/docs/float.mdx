...
<Example resizable>
  {
    <>
      ...
      <p className="text-justify">
        也许我们可以没有图书馆，像你和我这样的人。也许。我们确实太老而无法改变世界，但
        现在那个坐下来打开书的小孩呢，在当地图书馆的某个分馆里发现《帽子里的猫》和《五个中国兄弟》上的尿尿和便便的画？难道他不值得更好吗？看看。如果你认为这与滞纳金和丢失的书籍有关，那你最好再想想。这关乎那个孩子的权利，能阅读一本书而不让他的思想扭曲！或者：也许这让你兴奋，赛尔芬；也许这就是你获得乐趣的方式。你和你的好朋友们。
      </p>
    </>
  }
</Example>
...
使用 `float-start` 和 `float-end` 工具类，这些工具类使用 [逻辑属性](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts) 根据文本方向映射到左侧或右侧：
...
<Example resizable>
  {
    <>
      <div dir="ltr">
        <p className="mb-4 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">从左到右</p>
        <div>
          <img
          ...
          />
          <p className="text-justify">
            也许我们可以没有图书馆，像你和我这样的人。也许。我们确实太老而无法改变世界，
            但现在那个坐下来打开书的小孩呢，在当地图书馆的某个分馆里发现《帽子里的猫》和
            《五个中国兄弟》上的尿尿和便便的画？难道他不值得更好吗？看看。如果你认为这与滞纳金和丢失的书籍有关，那你最好再想想。
            这关乎那个孩子的权利，能阅读一本书而不让他的思想扭曲！或者：也许这让你兴奋，赛尔芬；
            也许这就是你获得乐趣的方式。你和你的好朋友们。
          </p>
        </div>
      </div>
      <div dir="rtl" className="mt-6">
        <p className="mb-4 font-mono text-xs font-medium text-gray-500 dark:text-gray-400">从右到左</p>
        <div>
          <img
            className="float-start me-6 aspect-16/9 w-2/5 rounded-lg object-cover outline -outline-offset-1 outline-black/10"
            src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=90"
