...
<Example>
  {
    <div className="flex flex-col gap-8 text-gray-900 dark:text-gray-200">
      <div>
        ...
        <p className="text-lg font-medium underline decoration-solid">快速的棕色狐狸跳过懒狗。</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p className="text-lg font-medium underline decoration-dotted">快速的棕色狐狸跳过懒狗。</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-sm font-medium text-gray-500 dark:text-gray-400">decoration-dashed</div>
        <p className="text-lg font-medium underline decoration-dashed">快速的棕色狐狸跳过懒狗。</p>
      </div>
      <div>
        <div className="mb-3 font-mono text-sm font-medium text-gray-500 dark:text-gray-400">decoration-wavy</div>
        <p className="text-lg font-medium underline decoration-wavy">快速的棕色狐狸跳过懒狗。</p>
      </div>
    </div>
  }
</Example>
