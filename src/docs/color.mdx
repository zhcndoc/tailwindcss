...
export const description = "用于控制元素文本颜色的工具。";
...
使用像 `text-blue-600` 和 `text-sky-400` 这样的工具来控制元素的文本颜色：
...
<Example>
  {
    <div className="relative text-center text-xl leading-6 font-medium">
      <p className="text-blue-600 dark:text-sky-400">快速的棕色狐狸跳过懒狗。</p>
    </div>
  }
</Example>
...
<Example>
  {
    <div className="space-y-4 text-center text-xl leading-6 font-medium">
      <p className="text-blue-600/100 dark:text-sky-400/100">快速的棕色狐狸跳过懒狗。</p>
      <p className="text-blue-600/75 dark:text-sky-400/75">快速的棕色狐狸跳过懒狗。</p>
      <p className="text-blue-600/50 dark:text-sky-400/50">快速的棕色狐狸跳过懒狗。</p>
      <p className="text-blue-600/25 dark:text-sky-400/25">快速的棕色狐狸跳过懒狗。</p>
    </div>
  }
</Example>
