...
export const description = "应用模糊滤镜到元素的实用工具。";
...
使用实用工具如 `blur-sm` 和 `blur-lg` 模糊一个元素：
    ...
    <div className="flex scroll-p-8 overflow-scroll sm:block sm:overflow-visible">
      <div className="flex shrink-0 items-center justify-around gap-12 p-8 font-mono font-bold sm:gap-4">
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">blur-none</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">blur-sm</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">blur-lg</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">blur-2xl</p>
