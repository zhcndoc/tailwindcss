...
<Example>
  {
    <div className="grid grid-cols-1 gap-10 px-0 sm:grid-cols-2 sm:px-10">
      <div className="flex flex-col">
        <p className="mb-3 font-mono text-sm font-medium text-gray-500 dark:text-gray-400">pointer-events-auto</p>
      ...
      <div className="flex flex-col">
        <p className="mb-3 font-mono text-sm font-medium text-gray-500 dark:text-gray-400">pointer-events-none</p>
        <div className="relative w-full rounded-lg shadow-sm">
