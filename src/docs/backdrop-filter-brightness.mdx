...
export const description = "用于向元素应用背影亮度滤镜的工具类。";
...
使用 `backdrop-brightness-50` 和 `backdrop-brightness-100` 等工具类来控制元素的背影亮度：
...
<UsingACustomValue utility="backdrop-brightness" value="1.75" name="背影亮度" />
