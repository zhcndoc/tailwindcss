...
使用 `border-spacing-<number>` 工具类，如 `border-spacing-2` 和 `border-spacing-x-3` 来控制表格单元格边框之间的间距，适用于[分隔边框的表格](/docs/border-collapse#separating-table-borders):
...
<table class="border-separate border-spacing-2 border border-gray-400 dark:border-gray-500">
  ...
  <tbody>
    <tr>
      <td class="border border-gray-300 dark:border-gray-700">印第安纳州</td>
      <td class="border border-gray-300 dark:border-gray-700">印第安波利斯</td>
    </tr>
    <tr>
      <td class="border border-gray-300 dark:border-gray-700">俄亥俄州</td>
      <td class="border border-gray-300 dark:border-gray-700">哥伦布</td>
    </tr>
    <tr>
      <td class="border border-gray-300 dark:border-gray-700">密歇根州</td>
