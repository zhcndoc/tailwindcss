...
export const description = "用于给元素应用投影滤镜的工具类。";
...
这对于不规则形状（如文本和 SVG 元素）添加投影效果非常有用。对于规则元素，您可能更希望使用 [盒子阴影](/docs/box-shadow)。
...
使用工具类如 `drop-shadow-indigo-500` 和 `drop-shadow-cyan-500/50` 更改投影的颜色：
...
<UsingACustomValue element="svg" utility="drop-shadow" value="0_35px_35px_rgba(0,0,0,0.25)" name="投影" />
