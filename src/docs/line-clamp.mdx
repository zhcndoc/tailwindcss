...
export const description = "限制文本显示特定行数的工具类。";
...
使用 `line-clamp-<number>` 工具类，如 `line-clamp-2` 和 `line-clamp-3`，以在特定行数后截断多行文本：
...
<Example padding={false}>
  {
    <div className="px-4 sm:px-0">
      <article className="mx-auto max-w-sm p-8 text-gray-700 dark:text-gray-400">
        ...
        <div className="mt-2 text-lg font-semibold text-gray-900 dark:text-gray-200">提升你的转化率</div>
