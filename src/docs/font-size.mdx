...
export const description = "控制元素字体大小的工具类。";
...
使用 `text-sm` 和 `text-lg` 等工具类设置元素的字体大小：
...
```html
<!-- [!代码类:text-sm,text-base,text-lg,text-xl,text-2xl] -->
<p class="text-sm ...">敏捷的棕色狐狸 ...</p>
<p class="text-base ...">敏捷的棕色狐狸 ...</p>
<p class="text-lg ...">敏捷的棕色狐狸 ...</p>
<p class="text-xl ...">敏捷的棕色狐狸 ...</p>
<p class="text-2xl ...">敏捷的棕色狐狸 ...</p>
```
...
使用 `text-sm/6` 和 `text-lg/7` 等工具类同时设置元素的字体大小和行高：
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm/6 text-gray-900 dark:text-gray-200">
          所以我开始走进水中。老兄们，我不会撒谎，我感到非常害怕。但我继续前进，当我过去
          遇到浪潮时，一种奇怪的平静感涌上心头。我不知道那是神的干预还是所有生物的亲密关系，但我告诉你，杰瑞，在那一刻，我 <em>是</em> 一个海洋生物学家。
        </p>
      </div>
      <div>
...
```html
<!-- [!代码类:text-sm/6,text-sm/7,text-sm/8] -->
...
@theme {
  --text-tiny: 0.625rem;
  --text-tiny--line-height: 1.5rem; /* [!代码高亮] */
  --text-tiny--letter-spacing: 0.125rem; /* [!代码高亮] */
  --text-tiny--font-weight: 500; /* [!代码高亮] */
}
```
