...
export const description = "用于控制元素的背面是否可见的工具。";
...
使用 `backface-visible` 工具，即使元素旋转到视线外，也可以显示元素的背面，比如一个立方体：
...
<div class="size-20 ...">
  ...
  <div class="-translate-z-12 rotate-y-180 bg-sky-300/75 backface-hidden ...">2</div>
...
<div class="size-20 ...">
  ...
  <div class="-translate-z-12 rotate-y-180 bg-sky-300/75 backface-visible ...">2</div>
