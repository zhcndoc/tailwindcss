...
export const title = "透视";
export const description = "用于控制元素在三维空间中的透视效果的工具类。";
...
使用诸如 `perspective-normal` 和 `perspective-distant` 等工具类来控制 z 轴平面距离屏幕的远近：
...
使用 `perspective-none` 工具类来从元素中移除透视变换：
...
<CustomizingYourTheme utility="perspective" name="透视" customName="remote" customValue="1800px" />