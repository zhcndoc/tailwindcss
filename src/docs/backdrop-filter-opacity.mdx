...
export const description = "用于将背景不透明度滤镜应用于元素的工具类。";
...
使用类似 `backdrop-opacity-50` 和 `backdrop-opacity-75` 的工具类来控制应用于元素的所有背景滤镜的不透明度：
...
```html
<!-- [!代码 类名:backdrop-opacity-10,backdrop-opacity-60,backdrop-opacity-95] -->
