...
export const title = "文本下划线偏移量";
export const description = "控制文本下划线偏移量的工具。";
...
使用 `underline-offset-<number>` 工具，如 `underline-offset-2` 和 `underline-offset-4` 来改变文本下划线的偏移量：
...
<p class="underline underline-offset-1">敏捷的棕色狐狸...</p>
<!-- [!code classes:underline-offset-2] -->
<p class="underline underline-offset-2">敏捷的棕色狐狸...</p>
<!-- [!code classes:underline-offset-4] -->
<p class="underline underline-offset-4">敏捷的棕色狐狸...</p>
<!-- [!code classes:underline-offset-8] -->
<p class="underline underline-offset-8">敏捷的棕色狐狸...</p>
```
