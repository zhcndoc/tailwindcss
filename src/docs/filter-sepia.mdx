...
export const title = "过滤器：sepia()";
export const description = "用于将深褐色滤镜应用于元素的工具。";
...
使用 `sepia` 和 `sepia-50` 等工具来控制应用于元素的深褐色效果：
    ...
    <div className="flex scroll-p-8 justify-center overflow-scroll sm:block sm:overflow-visible">
      <div className="flex shrink-0 items-center justify-around gap-6 p-8 font-mono font-bold sm:gap-4">
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">sepia-0</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">sepia-50</p>
        ...
        <div className="flex shrink-0 flex-col items-center">
          <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">sepia</p>
