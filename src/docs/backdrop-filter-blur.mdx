...
export const description = "用于将背景模糊滤镜应用于元素的工具类。";
...
使用类似 `backdrop-blur-sm` 和 `backdrop-blur-lg` 的工具类来控制元素的背景模糊：
...
<UsingACustomValue utility="backdrop-blur" value="2px" name="背景模糊" />
...
<CustomizingYourTheme utility="backdrop-blur" themeKey="blur" name="背景模糊" customName="2xs" customValue="2px" />