...
使用 `border` 或 `border-<number>` 工具类，如 `border-2` 和 `border-4` 来设置元素所有边的边框宽度：
...
<Example>
  {
    <div className="flex flex-col items-center justify-around gap-4 text-center text-sm leading-6 font-bold text-white sm:flex-row">
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border</p>
        <div className="size-16 border border-indigo-600 p-4"></div>
      </div>
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-2</p>
        <div className="size-16 border-2 border-indigo-600 p-4"></div>
      </div>
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-4</p>
        <div className="size-16 border-4 border-indigo-600 p-4"></div>
      </div>
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-8</p>
...
使用 `border-r` 和 `border-t-4` 等工具类来设置元素一个边的边框宽度：
...
<Example>
  {
    <div className="flex flex-col items-center justify-around gap-4 text-center text-sm leading-6 font-bold text-white sm:flex-row">
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-t-4</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-r-4</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-b-4</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-l-4</p>
...
使用 `border-x` 和 `border-y-4` 等工具类同时设置元素两个边的边框宽度：
...
<Example>
  {
    <div className="flex flex-col items-center justify-around gap-4 text-center text-sm leading-6 font-bold text-white sm:flex-row">
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-x-4</p>
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">border-y-4</p>
...
使用 `border-s` 和 `border-e-4` 等工具类来设置 `border-inline-start-width` 和 `border-inline-end-width` [逻辑属性](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts)，这些逻辑属性根据文本方向映射到左边或右边：
...
如果你的元素顺序反转（使用如 `flex-row-reverse` 或 `flex-col-reverse`），使用 `divide-x-reverse` 或 `divide-y-reverse` 工具类来确保边框添加到每个元素的正确边：
