...
人们在讨论如何在 Tailwind 项目中最好地排序您的实用类，已经 <Link href="https://github.com/tailwindlabs/discuss/issues/97">至少有四年了</Link>。今天我们很高兴地宣布，随着我们正式发布的 <Link href="https://github.com/tailwindlabs/prettier-plugin-tailwindcss">Prettier 插件</Link>，您终于可以不再担心这个问题。

<Link href="https://github.com/tailwindlabs/prettier-plugin-tailwindcss">
  <Image alt="Tailwind CSS v3.4" src={banner} />
</Link>

该插件扫描您的模板中的类属性，查找包含 Tailwind CSS 类的属性，然后自动按照我们的 [推荐类顺序](#how-classes-are-sorted) 对这些类进行排序。
